...
class LinkFlows : public InitialiseSolution { 
	public:
		...
		*/
		...
		void setMinTravlTime(FPType _val) { minTravelTime_ = _val; }
		...
		*/
		...
		void setLinkFlows(int linkindex, FPType flowvalue) { linkFlows_[linkindex] = flowvalue; }
		void setLinkFlowsAux(int linkindex, FPType flowvalue) { linkFlowsAux_[linkindex] = flowvalue; }
		AONUsual* getAon() { return &aon_; }
	protected:
